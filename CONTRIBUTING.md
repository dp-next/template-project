...
while using template-project. You can do this by creating a new issue on our
GitHub repository.
...
To contribute to `template-project`, you first need to install
